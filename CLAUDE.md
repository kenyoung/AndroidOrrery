...
When adding a new feature (but not just a minor change), create a new git branch first. Then work on changes to that branch until you are asked to merge it.
